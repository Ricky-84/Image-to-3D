...
1. **Clone the Repository** (if applicable):
   ```bash
   git clone https://github.com/Ricky-84/Image-to-3D
   cd text-image-to-3D
   ```
...
2. **Run the Script**:
   ```bash
   python main.py --input_type image --input_file input/sample_image2.jpg --output_file output/model5.obj
   ```
...
3. **Output**:
   - The script will generate a 3D mesh and save it as `output/model5.obj`.
...
- `output/model5.obj`: Generated 3D mesh.
